...
export const AiAssistant: React.FC<AiAssistantProps> = ({ personData }) => {
  ...
  const formattedAnalysis = useMemo(() => {
    ...
    // This complex regex manipulation is to ensure lists are correctly formatted within a single <ul> tag.
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg">
      <div className="flex items-center mb-4">
        <SparklesIcon className="h-8 w-8 text-brand-secondary" />
        <h2 className="text-2xl font-bold text-brand-primary dark:text-blue-400 ml-3">
